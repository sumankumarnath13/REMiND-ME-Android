...
public class AboutApp extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActivityTitle(getResources().getString(R.string.menu_label_app_about));
        ...
        btn_view_faq.setOnClickListener(v -> {
        ...
        btn_view_license.setOnClickListener(v -> {
        ...
        btn_share_app.setOnClickListener(v -> shareText("DING DONG Friends"));
    }
